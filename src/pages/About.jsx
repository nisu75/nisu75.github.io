...
export default function AboutDisplay() {
    return (<div className="page">
        <div className="text">
            ...
            Nice to meet you! I'm Nicole Cui, a Computer Science student at the University of Waterloo. 
            <br /><br />
            I'm interested in cybersecurity and front-end development, as well as digital product design. I've dabbled in photo and video editing through Adobe Suite, and done more than just dabbling in graphic design, music, and visual art. 
            <br /><br />
            ...
            <br /><br />
            Feel free to reach out - I'd love to chat and connect more! (*´▽`)ﾉ
            </div>
